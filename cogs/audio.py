...
log = logging.getLogger("necrozma.audio")
...
class Audio:
    ...
    @checks.serverowner_or_permissions(administrator=True)  # cause effect is cross-server
    ...
    async def cache_stats(self):
        """Reports info about the cache.
            ...
            - Minimum cache size. Automatically determined by number of servers Necrozma is running on.
        """
    ...
    async def sing(self, ctx):
        """Makes Necrozma sing one of her songs"""
...
def setup(bot):
    ...
    if opus is False:
        ...
        raise RuntimeError(
            ...
            "Twentysix26/Necrozma-DiscordBot/wiki/Requirements\"")
