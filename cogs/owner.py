...
log = logging.getLogger("necrozma.owner")
...
class Owner:
    ...
    def __init__(self, bot):
        ...
        self.disabled_commands = dataIO.load_json("data/necrozma/disabled_commands.json")
        self.global_ignores = dataIO.load_json("data/necrozma/global_ignores.json")
    ...
    async def _set(self, ctx):
        """Changes Necrozma's core settings"""
    ...
    async def owner(self, ctx):
        ...
        if self.bot.settings.no_prompt is True:
            await self.bot.say("Console interaction is disabled. Start Necrozma "
    ...
    async def prefix(self, ctx, *prefixes):
        """Sets Necrozma's global prefixes
    ...
    async def serverprefix(self, ctx, *prefixes):
        """Sets Necrozma's prefixes for this server
    ...
    async def game(self, ctx, *, game=None):
        """Sets Necrozma's playing status
    ...
    async def stream(self, ctx, streamer=None, *, stream_title=None):
        """Sets Necrozma's streaming status
    ...
    async def _blacklist_add(self, user: discord.Member):
        """Adds user to Necrozma's global blacklist"""
    ...
    async def _blacklist_remove(self, user: discord.Member):
        """Removes user from Necrozma's global blacklist"""
    ...
    async def whitelist(self, ctx):
        ...
        be able to use Necrozma"""
        if ctx.invoked_subcommand is None:
            await self.bot.send_cmd_help(ctx)

    @whitelist.command(name="add")
    async def _whitelist_add(self, user: discord.Member):
        """Adds user to Necrozma's global whitelist"""
    ...
    async def _whitelist_remove(self, user: discord.Member):
        """Removes user from Necrozma's global whitelist"""
    ...
    async def restart(self, silently : bool=False):
        """Attempts to restart Necrozma

        Makes Necrozma quit with exit code 26
    ...
    @commands.command()
    async def info(self):
        """Shows info about Necrozma"""
        author_repo = "https://github.com/Twentysix26"
        red_repo = author_repo + "/Necrozma-DiscordBot"
        server_url = "https://discord.gg/necrozma"
        ...
        about = (
            "This is an instance of [Necrozma, an open source Discord bot]({}) "
            "created by [Arch9SK7]({}) and improved by many.\n\n"
            "Necrozma is backed by a passionate community who contributes and "
            "creates content for everyone to enjoy. [Join us today]({}) "
            "and help us improve!\n\n"
            "".format(necrozma_repo, author_repo, server_url))

        embed = discord.Embed(colour=discord.Colour.red())
        embed.add_field(name="Instance owned by", value=str(owner))
        embed.add_field(name="Python", value=py_version)
        embed.add_field(name="discord.py", value=dpy_version)
        embed.add_field(name="About Necrozma", value=about, inline=False)
    ...
    async def version(self):
        """Shows Necrozma's current version"""
    ...
    def _get_version(self):
        if not os.path.isdir(".git"):
            msg = "This instance of Necrozma hasn't been installed with git."
    ...
    def save_global_ignores(self):
        dataIO.save_json("data/necrozma/global_ignores.json", self.global_ignores)

    def save_disabled_commands(self):
        dataIO.save_json("data/necrozma/disabled_commands.json", self.disabled_commands)
...
def check_files():
    if not os.path.isfile("data/necrozma/disabled_commands.json"):
        print("Creating empty disabled_commands.json...")
        dataIO.save_json("data/necrozma/disabled_commands.json", [])

    if not os.path.isfile("data/necrozma/global_ignores.json"):
        ...
        dataIO.save_json("data/necrozma/global_ignores.json", data)
