...
#
# Necrozma, a Discord bot by Arch9SK7, based on discord.py and its command
#                             extension.
#
#                   https://github.com/Arch9SK7/
#
#
# necrozma.py and cogs/utils/checks.py both contain some modified functions
#                     originally made by Proflayton123.
#

description = "Necrozma - A multifunction Discord bot by Arch9SK7"
...
class Bot(commands.Bot):
    ...
    async def shutdown(self, *, restart=False):
        """Gracefully quits Necrozma with exit code 0

        If restart is True, the exit code will be 26 instead
        The launcher automatically restarts Necrozma when that happens"""
...
def initialize(bot_class=Bot, formatter_class=Formatter):
    ...
    async def on_ready():
        ...
        print("\nOfficial server: https://discord.gg/pokemon-hub-discord")
...
def interactive_setup(settings):
    ...
    if first_run:
        print("Necrozma - First run configuration\n")
        print("If you haven't already, create a new account:\n"
              "https://twentysix26.github.io/Necrozma-Docs/red_guide_bot_accounts/"
    ...
    if first_run:
        ...
        print("\nThe configuration is done. Leave this window always open to"
              " keep Necrozma online.\nAll commands will have to be issued through"
              " Discord's chat, *this window will now be read only*.\n"
              "Please read this guide for a good overview on how Necrozma works:\n"
              "https://twentysix26.github.io/Necrozma-Docs/red_getting_started/\n"
...
def load_cogs(bot):
    ...
    if owner_cog is None:
        print("The owner cog is missing. It contains core functions without "
              "which Necrozma cannot function. Reinstall.")
        exit(1)
